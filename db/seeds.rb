...
recipe_list = [
  {
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F6864754.jpg&w=596&h=596&c=sc&poi=face&q=60"
  },
  {
    # category_id: c9.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F43%2F2020%2F09%2F10%2F618489.jpg"
  },
  {
    # category_id: c1.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F43%2F2022%2F04%2F25%2F77981-Butternut-Squash-Soup-II-mfs_Step5_006-1x1-1.jpg"
  },
  {
    # category_id: c8.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F43%2F2022%2F05%2F15%2F5834922-italian-baked-meatballs-kim-1x1-1.jpg"
  },
  {
    # category_id: c5.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F3087557.jpg&w=596&h=596&c=sc&poi=face&q=60"
  },
  {
    # category_id: c3.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F2276935.jpg"
  },
  {
    # category_id: c4.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F1014975.jpg"
  },
  {
    # category_id: c7.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F3533730.jpg"
  },
  {
    # category_id: c10.id,
    ...
    image_url:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F6103033.jpg"
  }
]

recipes = recipe_list.map { |recipe| Recipe.create(recipe) }

RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "New York Italian Style Cheesecake").id,
  category_id: Category.find_by(name: "dessert").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Baked Garlic Parmesan Chicken").id,
  category_id: Category.find_by(name: "chicken").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Baked Garlic Parmesan Chicken").id,
  category_id: Category.find_by(name: "dinner").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Butternut Squash Soup").id,
  category_id: Category.find_by(name: "soup").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Italian Baked Meatballs").id,
  category_id: Category.find_by(name: "dinner").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Apple Curry Turkey Pita").id,
  category_id: Category.find_by(name: "lunch").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Sweet Restaurant Slaw").id,
  category_id: Category.find_by(name: "salad").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Muffin Pan Frittatas").id,
  category_id: Category.find_by(name: "lunch").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Chef John's Pulled Pork BBQ").id,
  category_id: Category.find_by(name: "pork").id
)
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Chef John's Pulled Pork BBQ").id,
  category_id: Category.find_by(name: "dinner").id
...
RecipeCategory.create(
  recipe_id: Recipe.find_by(name: "Chef John's Sourdough Bread").id,
  category_id: Category.find_by(name: "bread").id
)
